...
function App() {
  return (
    <div className="relative overflow-y-auto overflow-x-hidden snap-y snap-mandatory h-screen">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        ...
        <div className="absolute top-0 -right-4 w-72 h-72 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float-delayed"></div>
